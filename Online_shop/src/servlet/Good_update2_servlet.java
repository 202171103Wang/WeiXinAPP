...
import online_db.Good_db;

/**
 * Servlet implementation class Good_update2_servlet
 */
@WebServlet("/Good_update2_servlet")
public class Good_update2_servlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String g_id=upload.getRequest().getParameter("Good_id");
