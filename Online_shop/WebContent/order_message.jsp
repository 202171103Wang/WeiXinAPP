<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
       ArrayList<Order_info> orders=(ArrayList<Order_info>)session.getAttribute("orders");
...
<body>
    ...
    <div class="tools">
    <ul class="toolbar1">
       <form name="form_3" action="Order_select1_servlet" method="post" >
        <label>年：</label><input type="text" name="year" class="dfinput" style="width:50px;"/>
        <label>月：</label><input type="text" name="month"class="dfinput" style="width:50px;"/>
        <label>日：</label><input type="text" name="day" class="dfinput" style="width:50px;"/>
    ...
    <td>未完成</td>
    <%} %>
    <td><img src="images/t04.png" /><a href ="Order_detail_select_servlet?i=<%=i%>">详情</a></td>
    </tr>
    <%} %>
    </tbody>
