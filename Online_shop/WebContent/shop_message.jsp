...
<body>
    ...
    <form name="form_2" action="edit_Shop.jsp" method="post" enctype="multipart/form-data">
    <div class="formbody">
    ...
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">本商铺信息展示</a></li> 
  	</ul>
    </div> 
    
  	<div id="tab1" class="tabson">
    
    <div class="formtext">Hi，<b>admin</b>，欢迎您试用商铺展示功能！</div>
    ...
    <li><label>商铺图片<b>*</b></label><img src="<%=s.getShop_img()%>" style="width:40px;height:40px;"/>
    <li><label>商铺营业状态<b>*</b></label>
          <% if(s.getShop_state()==1) {%>
          <input name="Shop_state" type="text" class="dfinput" value="正常营业"  style="width:518px;" readonly="readonly"/>
          <% }else {%>
          <input name="Shop_state" type="text" class="dfinput" value="暂停营业"  style="width:518px;" readonly="readonly"/>
          <% } %>
          </li>
    ...
    <div class="formtext"><b>只能修改名称和图片！</b></div>
    </ul>
