<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
       ArrayList<Order_detail_good> order_details=(ArrayList<Order_detail_good>)session.getAttribute("order_tdetails");
       String Orderid=(String)session.getAttribute("torderid");
    %>
<html>
<head>
...
<body>
    ...
    <ul class="placeul">
    <li><a href="#">订单</a></li>
    <li><a href="Order_selectt_servlet">当日订单信息</a></li>
    <li><a href="#">订单详情</a></li>
    </ul>
    </div>
